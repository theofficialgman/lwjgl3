...
JNIEXPORT void JNICALL Java_org_lwjgl_llvm_ClangDocumentation_nclang_1Cursor_1getParsedComment(JNIEnv *__env, jclass clazz, jlong __functionAddress, jlong CAddress, jlong __result) {
...
JNIEXPORT void JNICALL Java_org_lwjgl_llvm_ClangDocumentation_nclang_1Comment_1getChild(JNIEnv *__env, jclass clazz, jlong __functionAddress, jlong CommentAddress, jint ChildIdx, jlong __result) {
...
JNIEXPORT void JNICALL Java_org_lwjgl_llvm_ClangDocumentation_nclang_1TextComment_1getText(JNIEnv *__env, jclass clazz, jlong __functionAddress, jlong CommentAddress, jlong __result) {
...
JNIEXPORT void JNICALL Java_org_lwjgl_llvm_ClangDocumentation_nclang_1InlineCommandComment_1getCommandName(JNIEnv *__env, jclass clazz, jlong __functionAddress, jlong CommentAddress, jlong __result) {
...
JNIEXPORT void JNICALL Java_org_lwjgl_llvm_ClangDocumentation_nclang_1InlineCommandComment_1getArgText(JNIEnv *__env, jclass clazz, jlong __functionAddress, jlong CommentAddress, jint ArgIdx, jlong __result) {
...
JNIEXPORT void JNICALL Java_org_lwjgl_llvm_ClangDocumentation_nclang_1HTMLTagComment_1getTagName(JNIEnv *__env, jclass clazz, jlong __functionAddress, jlong CommentAddress, jlong __result) {
...
JNIEXPORT void JNICALL Java_org_lwjgl_llvm_ClangDocumentation_nclang_1HTMLStartTag_1getAttrName(JNIEnv *__env, jclass clazz, jlong __functionAddress, jlong CommentAddress, jint AttrIdx, jlong __result) {
...
JNIEXPORT void JNICALL Java_org_lwjgl_llvm_ClangDocumentation_nclang_1HTMLStartTag_1getAttrValue(JNIEnv *__env, jclass clazz, jlong __functionAddress, jlong CommentAddress, jint AttrIdx, jlong __result) {
...
JNIEXPORT void JNICALL Java_org_lwjgl_llvm_ClangDocumentation_nclang_1BlockCommandComment_1getCommandName(JNIEnv *__env, jclass clazz, jlong __functionAddress, jlong CommentAddress, jlong __result) {
...
JNIEXPORT void JNICALL Java_org_lwjgl_llvm_ClangDocumentation_nclang_1BlockCommandComment_1getArgText(JNIEnv *__env, jclass clazz, jlong __functionAddress, jlong CommentAddress, jint ArgIdx, jlong __result) {
...
JNIEXPORT void JNICALL Java_org_lwjgl_llvm_ClangDocumentation_nclang_1BlockCommandComment_1getParagraph(JNIEnv *__env, jclass clazz, jlong __functionAddress, jlong CommentAddress, jlong __result) {
...
JNIEXPORT void JNICALL Java_org_lwjgl_llvm_ClangDocumentation_nclang_1ParamCommandComment_1getParamName(JNIEnv *__env, jclass clazz, jlong __functionAddress, jlong CommentAddress, jlong __result) {
...
JNIEXPORT void JNICALL Java_org_lwjgl_llvm_ClangDocumentation_nclang_1TParamCommandComment_1getParamName(JNIEnv *__env, jclass clazz, jlong __functionAddress, jlong CommentAddress, jlong __result) {
...
JNIEXPORT void JNICALL Java_org_lwjgl_llvm_ClangDocumentation_nclang_1VerbatimBlockLineComment_1getText(JNIEnv *__env, jclass clazz, jlong __functionAddress, jlong CommentAddress, jlong __result) {
...
JNIEXPORT void JNICALL Java_org_lwjgl_llvm_ClangDocumentation_nclang_1VerbatimLineComment_1getText(JNIEnv *__env, jclass clazz, jlong __functionAddress, jlong CommentAddress, jlong __result) {
...
JNIEXPORT void JNICALL Java_org_lwjgl_llvm_ClangDocumentation_nclang_1HTMLTagComment_1getAsString(JNIEnv *__env, jclass clazz, jlong __functionAddress, jlong CommentAddress, jlong __result) {
...
JNIEXPORT void JNICALL Java_org_lwjgl_llvm_ClangDocumentation_nclang_1FullComment_1getAsHTML(JNIEnv *__env, jclass clazz, jlong __functionAddress, jlong CommentAddress, jlong __result) {
...
JNIEXPORT void JNICALL Java_org_lwjgl_llvm_ClangDocumentation_nclang_1FullComment_1getAsXML(JNIEnv *__env, jclass clazz, jlong __functionAddress, jlong CommentAddress, jlong __result) {
